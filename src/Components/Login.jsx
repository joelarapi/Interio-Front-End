  ...
  return (
    <div className="outerContainer">
      <div className={styles.container}>
        <div className={`${styles.imageContainer} ${isRegister ? styles.loginBackground : styles.signupBackground}`}></div>
        <div className={`${styles.formContainer}`}>
          <div className={`${styles.formWrapper}`}>
            ...
            <p className={`${styles.registerText} ${isConfirmationStep ? styles.hidden : ""}`}>
              ...
              <span onClick={toggleFormType}>{isRegister ? "Register here" : "Login here"}</span>
            </p>
            {isRegister ? (
              <form onSubmit={handleSubmit} className={`${styles.form}`}>
                <div className={styles.inputGroup}>
                  <div className={styles.labelWrapper}>
                    ...
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className={`${styles.input} ${isEmailFilled ? styles.filled : ""}`} />
                  </div>
                </div>
                <div className={styles.inputGroup}>
                  <div className={styles.labelWrapper}>
                    ...
                    <div className={styles.passwordWrapper}>
                      <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required className={`${styles.input} ${isPasswordFilled ? styles.filled : ""}`} />
                ...
                <button type="submit" className={`${styles.submitButton} ${styles.loginButton} ${isEmailFilled && isPasswordFilled ? styles.active : ""}`} disabled={!(isEmailFilled && isPasswordFilled)}>
                  Continue
                </button>
              </form>
            ) : isConfirmationStep ? (
              <form onSubmit={handleConfirmation} className={styles.form}>
                <>
                  <div className={styles.inputGroup}>
                    <input type="text" value={confirmationCode} placeholder={"Enter the confirmation code"} onChange={(e) => setConfirmationCode(e.target.value)} required className={`${styles.input} ${styles.verificationCodeInput}`} />
                  </div>
                  <button type="submit" className={`${styles.submitButton} ${styles.confirmButton} ${isConfirmationCodeFilled ? styles.active : ""}`} disabled={!isConfirmationCodeFilled}>
                    Confirm Signup
                  </button>
                  <button type="button" onClick={handleResendCode} className={`${styles.resendButton}`}>
                    Resend Code
                  </button>
                </>
              </form>
              ...
              <form onSubmit={handleSubmit} className={styles.form}>
                ...
                {userType === "client" ? (
                  <div className={styles.inputGroupClient}>
                    <div className={styles.labelWrapper}>
                      <label className={`${styles.label} ${firstName ? styles.labelFocused : ""}`}>First Name</label>
                      <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} required className={`${styles.input} ${isFirstNameFilled ? styles.filled : ""}`} />
                    </div>
                    <div className={styles.labelWrapper}>
                      <label className={`${styles.label} ${lastName ? styles.labelFocused : ""}`}>Last Name</label>
                      <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} required className={`${styles.input} ${isLastNameFilled ? styles.filled : ""}`} />
                    </div>
                  </div>
                ) : (
                  <div className={styles.inputGroupClient}>
                    <div className={styles.labelWrapper}>
                      <label className={`${styles.label} ${businessName ? styles.labelFocused : ""}`}>Business Name</label>
                      <input type="text" value={businessName} onChange={(e) => setBusinessName(e.target.value)} required className={`${styles.input} ${isBusinessNameFilled ? styles.filled : ""}`} />
                    </div>
                    <div className={styles.labelWrapper}>
                      <label className={`${styles.label} ${location ? styles.labelFocused : ""}`}>Location</label>
                      <input type="text" value={location} onChange={(e) => setLocation(e.target.value)} required className={`${styles.input} ${isLocationFilled ? styles.filled : ""}`} />
                    </div>
                  </div>
                )}
                <div className={styles.inputGroup}>
                  <div className={styles.labelWrapper}>
                    <label className={`${styles.label} ${createEmail ? styles.labelFocused : ""}`}>Email</label>
                    <input type="email" value={createEmail} onChange={(e) => setCreateEmail(e.target.value)} required className={`${styles.input} ${isCreateEmailFilled ? styles.filled : ""}`} />
                  </div>
                </div>
                <div className={styles.inputGroup}>
                  <div className={styles.labelWrapper}>
                    <label className={`${styles.label} ${createPassword ? styles.labelFocused : ""}`}>Password</label>
                    <div className={styles.passwordWrapper}>
                      <input type={showPassword ? "text" : "password"} value={createPassword} onChange={(e) => setCreatePassword(e.target.value)} required className={`${styles.input} ${isCreatePasswordFilled ? styles.filled : ""}`} />
                      <button type="button" onClick={togglePasswordVisibility} className={styles.passwordToggle}>
                        {showPassword ? <EyeOff size={30} /> : <Eye size={30} />}
                      </button>
                    </div>
                ...
                <div className={styles.inputGroup}>
                  <div className={styles.labelWrapper}>
                    ...
                    <div className={styles.passwordWrapper}>
                      <input type={showConfirmPassword ? "text" : "password"} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className={`${styles.input} ${isConfirmPasswordFilled ? styles.filled : ""}`} />
                ...
                <button type="submit" className={`${styles.submitButton} ${isRegister ? styles.loginButton : ""} ${(isRegister ? isEmailFilled && isPasswordFilled : isSignupFormFilled()) ? styles.active : ""}`} disabled={isRegister ? !(isEmailFilled && isPasswordFilled) : !isSignupFormFilled()}>
                  Continue
                </button>
              </form>
            )}
